    ...
    <body class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="https://docs.google.com/spreadsheets/d/1Szh9pH6q-Kb24pCW0mzy_sBgNFHAcp3Vo0vKSwSWisw/edit#gid=0" target="_blank"><i class='app-menu__icon bx bx-task'></i><span
                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form class="row" action="admin/confirm.jsp" method="GET" enctype="multipart/form-data">
