...
// insert product
    public void insertProduct(Product product) {
        ...
        try {
            ...
            ps.setFloat(4, (float) product.getProduct_price());
...
//---------------------------------------------------------------------------------------------//
//delete product(delete size->delete color->delete bill_detail->delete product)

    public void ProductDelete(String product_id) throws SQLException {
...
//--------------------------------------------------------------------------------------------------//
    //update(delete product_size-> delete color_id->inset product_size->insert product_color->update product)
    ...
    public void updateProduct(Product product) {
        ...
        try {
            ...
            ps.setFloat(3, (float) product.getProduct_price());
